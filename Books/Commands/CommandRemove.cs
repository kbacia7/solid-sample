...
{
    private IValidator[] validators;    //[0] => TypeValidator  [2] => BookExists, [3] => AuthorExists
    private IErrorOutput errorOutput;
    private IManager[] managers; //[0] => Author [1] => Book 

    public CommandRemove(IValidator[] _validators, IErrorOutput _errorOutput, IManager[] _managers)
    {
